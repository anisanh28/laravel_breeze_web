                    ...
                    <form action="{{ route('evaluasi.update', $evaluasi->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input
                                ...
                                name="judul_evaluasi"
                                id="judul_evaluasi"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm text-black focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50"
                        ...
                        <div class="mb-4">
                            ...
                            <input
                                type="text"
                                name="deskripsi_evaluasi"
                                id="deskripsi_evaluasi"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm text-black focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50"
                                value="{{ old('deskripsi_evaluasi', $evaluasi->deskripsi_evaluasi) }}"
                                required>
                        </div>
                        <div class="mb-4">
                            ...
                            <input
                                ...
                                id="start_time"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm text-black focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50"
                                value="{{ old('start_time', \Carbon\Carbon::parse($evaluasi->start_time)->format('Y-m-d\TH:i')) }}"
                                required>
                        </div>
                        <div class="mb-4">
                            ...
                            <input
                                ...
                                id="end_time"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm text-black focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50"
                                value="{{ old('end_time', \Carbon\Carbon::parse($evaluasi->end_time)->format('Y-m-d\TH:i')) }}"
                                required>
                        </div>
                        <div class="mb-4">
                            ...
                            <input
                                ...
                                id="durasi"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm text-black focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50"
                                value="{{ old('durasi', \Carbon\Carbon::parse($evaluasi->durasi)->format('H:i')) }}"
                                required>
                        </div>
                        <button type="submit" class="mt-4 bg-orange-600 text-white px-4 py-2 rounded-md hover:bg-orange-700">Update</button>
                    </form>
                </div>
            </div>
        </div>
