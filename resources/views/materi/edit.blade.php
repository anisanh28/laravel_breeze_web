                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('materi.update', $materi->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="judulMateri" id="judulMateri" value="{{ old('judulMateri', $materi->judulMateri) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm text-black focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50" required>
                        </div>
