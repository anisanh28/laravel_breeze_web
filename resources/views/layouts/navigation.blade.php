        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="Auth::user()->role=='guru'? route('guru.dashboard') : route('dashboard')" :active="Auth::user()->role=='guru'? request()->routeIs('guru.dashboard') : request()->routeIs('dashboard')">
                        {{ __('Dashboard') }}
                    </x-nav-link>

                    <!-- Guru links -->
                    @if(Auth::user()->role=='guru')
                    <x-nav-link href="/guru/anggota" :active="request()->routeIs('guru.anggota')">
                        {{ __('Anggota') }}
                    </x-nav-link>

                    <x-nav-link href="/guru/materi" :active="request()->routeIs('guru.materi')">
                        {{ __('Materi') }}
                    </x-nav-link>
